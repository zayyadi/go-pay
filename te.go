...
// 		return nil
// 	}
// 	basic := new(big.Float).Mul(annualGross, big.NewFloat(0.4))
// 	return basic
// }
...
// 	fmt.Printf("Annual Income: ₦%s\n", FormatWithThousandSeparator(emp.GetAnnualGross()))
// 	fmt.Printf("Gross: ₦%s\n", FormatWithThousandSeparator(emp.Gross))
// 	fmt.Printf("Water: ₦%s\n", FormatWithThousandSeparator(emp.GetWaterFee()))
// 	fmt.Printf("Housing: ₦%s\n", FormatWithThousandSeparator(emp.GetHousingAmount()))
// 	fmt.Printf("Cons relief: ₦%s\n", FormatWithThousandSeparator(emp.GetConsolidatedRelief()))
// 	formatCons := FormatWithThousandSeparator(emp.GetConsolidated())
// 	fmt.Printf("Cons: ₦%s\n", formatCons)
// 	fmt.Printf("First taxable: %s\n", FormatWithThousandSeparator(emp.FirstTaxable()))
// 	fmt.Printf("Second taxable: %s\n", FormatWithThousandSeparator(emp.SecondTaxable()))
// 	fmt.Printf("Third taxable: %s\n", FormatWithThousandSeparator(emp.ThirdTaxable()))
// 	fmt.Printf("Fourth taxable: %s\n", FormatWithThousandSeparator(emp.FourthTaxable()))
// 	fmt.Printf("Fifth taxable: %s\n", FormatWithThousandSeparator(emp.FifthTaxable()))
